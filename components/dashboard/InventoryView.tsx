          ...
          >
            {nutrients.length === 0 ? (
              ...
              <div className="space-y-6 animate-in fade-in duration-200">
                ...
                {/* Interactive Search, Filters & Batch Action Toolbar */}
                <div className="bg-[#070D1E]/60 border border-border/80 rounded-xl p-4 flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                  ...
                  {selectedNutrientIds.length > 0 && (
                    <div className="flex items-center gap-2 bg-[#D4FF00]/10 border border-[#D4FF00]/30 rounded-lg px-3.5 py-1.5 animate-in fade-in zoom-in-95 duration-150">
                      <span className="text-[11px] font-mono font-bold text-[#D4FF00]">
                        {selectedNutrientIds.length} Selected:
                      </span>
                      <Button
                        type="button"
                        variant="primary"
                      ...
                      {isAdmin && (
                        <Button
                          ...
                          className="h-7 text-[10px] px-2.5 font-mono border-rose-500/40 text-rose-400 hover:bg-rose-500/10"
                        >
                          Delete Selected
                        </Button>
                      )}
                ...
                {filteredNutrients.length === 0 ? (
                  <div className="bg-[#070D1E]/40 border border-border/80 rounded-xl p-8 text-center text-muted-foreground text-xs font-mono">
                    No nutrient products match the current filters or search term.
                  </div>
                ) : (
                    ...
                    {filteredNutrients.map((item) => {
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            'bg-[#070D1E] border rounded-xl p-4 flex flex-col justify-between gap-3 relative group shadow-sm transition-all cursor-pointer select-none',
                            isSelected ? 'border-[#D4FF00] ring-1 ring-[#D4FF00]' : 'border-border/80 hover:border-border'
                          )}
                        >
                            ...
                            <div className="flex items-start gap-2.5">
                              ...
                              <div
                                className={cn(
                                  ...
                                  isSelected ? 'bg-[#D4FF00] border-[#D4FF00] text-black' : 'border-muted-foreground/60'
                                )}
                              >
