...
export function PurchaseOrderModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
      <div className="bg-[#0B132B] border border-border rounded-xl w-full max-w-lg p-4 space-y-3.5 shadow-2xl animate-in fade-in zoom-in-95 duration-150 font-sans">
